...
<head>
    ...
    <link rel="stylesheet" href="css/stylecv2.css">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.3.1/jspdf.umd.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.3.2/html2canvas.min.js"></script>

    <script src="css/scriptcv2.js" defer></script>
    <script src="css/scriptvista2.js" defer></script>
</head>
<body>
    <form method="POST" id="cv-form">
        ...
        <div>
            ...
            <center>
                <input type="button" value="Imprimir" onclick="generarCV()">
            </center>
